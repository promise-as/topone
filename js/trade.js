...
var app = new Vue({
  ...
  methods: {
    ...
    timeShare1: function () {
      console.log('周期')
      axios.post('http://www.test.com/test.php', {"time":this.timeNum1}).then(function (response) {

      }).catch(function (error) {
        // 弹框提示
        dialog(this.timeNum1, error)
      })
    },
    timeShare2: function () {
      axios.post('http://www.test.com/test.php', {"time":this.timeNum2}).then(function (response) {

      }).catch(function (error) {
        // 弹框提示
        dialog(this.timeNum2, error)
      })
    },
    timeShare3: function () {
      axios.post('http://www.test.com/test.php', {"time":this.timeNum3}).then(function (response) {

      }).catch(function (error) {
        // 弹框提示    
        dialog(this.timeNum3, error)
      })
    },
    timeShare4: function () {
      axios.post('http://www.test.com/test.php', {"time":this.timeNum4}).then(function (response) {

      }).catch(function (error) {
        // 弹框提示
        dialog(this.timeNum4, error)
      })
    },
    ...
    /*buy: function () {
      var that = this
      var buying = this.num != '' ? this.num : this.money   //买入数量
      axios.post('url', {}).then(function (response) {
